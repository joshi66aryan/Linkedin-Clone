...
//state
  ...
  const reset = (e) => {  //reset whatever written in textarea
    setEditorText("");
    setShareImage("");
    setVideoLink("");
    props.handleClick(e);
  ...
  return (
    <>
        { props.showModal === 'open' && photoToggle ==='close' && videoToggle ==='close' ?//popping postmodal functionality
            <Container>
                <Content>
                    <Header>
                    <h2>Create a Post</h2>
            ...
            <Container>
              <Content>
                  ...
                  <PhotoCreation>
                      ...
                      <PostButton disabled = {!shareImage ? true : false}  onClick={(e)=>postArticle(e)}> Post </PostButton>
                  </PhotoCreation>
              </Content>
            </Container>
              ...
              <Content>
                  ...
                  <PhotoContent>
                      <PhotoEditor>
                        ...
                        {videoLink && file && (<video width={"100%"} height={"400px"} controls src={videoLink}/>) }
                      </PhotoEditor>
                  </PhotoContent>
                  <PhotoCreation>
                      <BackButton onClick={videoClick}> Back </BackButton>
                      <PostButton  disabled = {!videoLink ? true : false} onClick={(e)=>postArticle(e)}>Post</PostButton>
                  </PhotoCreation>
              </Content>
            </Container>
            :null
